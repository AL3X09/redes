...
<link href="<?php echo base_url(); ?>css/tingle.css" type="text/css" rel="stylesheet"/>
<meta name="viewport" content="width=device-width, initial-scale=1, maximum-scale=1.0"/>
<title> TUS MENSAJES RECIBIDOS </title>
</head>
...
<div class="section no-pad-bot" id="index-banner">
    <div class="container">
        <br><br>
        <h4 class="header center orange-text">MODULO RECEPCIÓN MENSAJES PARA <span id="userlog" class="blue-text"><?php echo $aspirante->usuario ?></span></h4>
...
<nav class="nav-extended">
    <div class="nav-wrapper">
      <a href="#" class="brand-logo">Mensajes</a>
      
    </div>
    <div class="nav-content">
      <div class="col s12 m12">
         <div class="card-panel hoverable">
            <div class="card-content" id="contmensaje">
...
<a class="waves-effect waves-light btn tingle_addon_2 ">Ver Codificado</a>
    ...
    <!--CONT DATAGRAM-->
    <div id="contdatagrama" class="tingle_addon_window hide">
        <h6 class="header center orange-text">ULTIMO DATAGRAMA ENVIADO FUE</h6>

        <div class="row">
                <div class="input-field col s3">
                    <input placeholder="ingrese version" id="version" name="version" type="text" class="validate" disabled >
                    <label for="first_name">Versión</label>
                </div>
                <div class="input-field col s3">
                    <input placeholder="ingrese texto" id="cabecera" name="cabecera" type="text" class="validate" disabled>
                ...
                <div class="input-field col s3">
                    <input placeholder="ingrese números" id="longitudT" name="longitudT" type="text" class="validate" disabled>
            ...
            <div class="row">
                <div class="input-field col s5">
                    <input placeholder="ingrese version" id="identificacion" name="identificacion" type="text" class="validate" disabled>
                    <label for="first_name">Identificación</label>
                </div>
                <div class="input-field col s3">
                    <input placeholder="ingrese texto" id="flag" name="flag" type="text" class="validate" disabled>
                    <label for="first_name">Flag</label>
                    <input placeholder="ingrese texto" id="" name="" type="hidden" class="validate" disabled>
                </div>
                <div class="input-field col s4">
                    <input placeholder="ingrese números" id="offset" name="offset" type="text" class="validate" disabled>
            ...
            <div class="row">
                <div class="input-field col s3">
                <input placeholder="ingrese version" id="ttl" name="ttl" type="text" class="validate" disabled>
     ...
     <select id="protocolo" name="protocolo">
      ...
      <option value="139"> HIP (Host Identity Protocol)</option>
                ...
                <div class="input-field col s5">
                    <input placeholder="ingrese números" id="checksum" name="checksum" type="text" class="validate" disabled>
            ...
            <!-- cuarta fila  -->
             <div class="row">
                <div class="input-field col s12">
                    <input placeholder="ingrese números" id="ip1" name="ip1" type="text" class="validate" disabled>
             ...
             <div class="row">
                ...
                <div class="input-field col s12">
                    <input placeholder="ingrese mensaje" id="msj" name="msj" type="text" class="validate" disabled>
    ...
    <!--FIN DIV CONTDATAGRAMA-->

    <!--DIV CONTDATAGRAMA CODIFICADO-->
    <div id="codificado" class="tingle_addon_window_2 hide">
...
<script src="<?php echo base_url(); ?>js/tingle.js"></script>
<script src="<?php echo base_url(); ?>js/mensaje.js"></script>
</body>
</html>